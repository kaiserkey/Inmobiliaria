...
CREATE TABLE IF NOT EXISTS `Inmobiliaria`.`Inmueble` (
  ...
  `Precio` DECIMAL NULL,
  `Ambientes` INT NULL,
  `Uso` ENUM("residencial", "comercial") NULL,
  `Activo` TINYINT NULL,
...
-- -----------------------------------------------------
-- Table `Inmobiliaria`.`Multa`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Inmobiliaria`.`Multa` (
  `idMulta` INT NOT NULL,
  `Importe` DECIMAL NULL,
  `IdInquilino` INT NOT NULL,
  PRIMARY KEY (`idMulta`),
  INDEX `fk_Multa_Inquilino1_idx` (`IdInquilino` ASC) VISIBLE,
  CONSTRAINT `fk_Multa_Inquilino1`
    FOREIGN KEY (`IdInquilino`)
    REFERENCES `Inmobiliaria`.`Inquilino` (`IdInquilino`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
